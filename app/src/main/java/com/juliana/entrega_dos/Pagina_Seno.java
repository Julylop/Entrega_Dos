...
public class Pagina_Seno extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pagina_seno);
        ...
        calcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (grados.isChecked()) {
                    ...
                    Intent intent = new Intent(Pagina_Seno.this, Pagina_resultados.class);
